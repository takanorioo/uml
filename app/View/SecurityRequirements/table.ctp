...
<?php if (!empty($security_requirement[0]['CountermeasureBind'])): ?>
	...
	<div style="float: right;">
		...
		<h1 style="margin-top: -44px;"><a href="/<?php echo $base_dir;?>/element/sr_testcasedata/<?php echo h($method['Method']['id']);?><? echo $conditions?>" class ="btn btn-primary">Create Test Script</a></h1>
	</div>
